...
dependencies {
    ...
    implementation("net.fabricmc.fabric-api:fabric-message-api-v1:7.0.7+086d547a9e")
    implementation("net.fabricmc.fabric-api:fabric-rendering-v1:25.3.0+67c847259e")
